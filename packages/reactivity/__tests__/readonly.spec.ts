import { isReactive, readonly, isProxy, isReadonly, effect, reactive, markRaw, toRaw, ref } from "../src"
...
describe('reactivity/readonly', () => {
  ...
  maps.forEach((Collection: any) => {
    describe(Collection.name, () => {
      ...
      if (Collection === Map) {
        it('should retrieve readonly values on iteration', () => {
          const key1 = {}
          const key2 = {}
        ...
        it('should retrieve reactive + readonly values on iteration', () => {
          const key1 = {}
          const key2 = {}
  ...
  it('calling reactive on an readonly should return readonly', () => {
    const a = readonly({})
    const b = reactive(a)
  ...
  it('calling readonly on a reactive object should return readonly', () => {
    const a = reactive({})
    const b = readonly(a)
    expect(isReadonly(b)).toBe(true)
    // should point to same original
  ...
  it('readonly should track and trigger if wrapping reactive original', () => {
  ...
  it('readonly collection should not track', () => {
    const map = new Map()
    map.set('foo', 1)
  ...
  // it('readonly array should not track', () => {
  //   const arr = [1]
  ...
  it('readonly should track and trigger if wrapping reactive original (collection)', () => {
  ...
  it('wrapping already wrapped value should return same Proxy', () => {
    const original = { foo: 1 }
    const wrapped = readonly(original)
  ...
  it('wrapping the same value multiple times should return same Proxy', () => {
    const original = { foo: 1 }
    const wrapped = readonly(original)
  ...
  it('should make ref readonly', () => {
    ...
    // it('calling readonly on computed should allow computed to set its private properties', () => {
