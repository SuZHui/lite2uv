import { effect, ref, reactive, isRef, Ref, unref, isReactive, shallowRef, triggerRef, isShallow, computed, toRef, toRefs, customRef, shallowReactive, readonly } from '../src'
...
describe('reactivity/ref', () => {
  ...
  // FIXME: 单元测试未通过
  it('ref should preserve value shallow/readonly-ness', () => {
    const original = {}
